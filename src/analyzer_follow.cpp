...
struct AnalyzerFollow {
   ...
   int add_edge(int id_follower, int agent_to_follow){
    ...
    bool follow_agent(int id_follower, double time_of_follow) {
		...
		add_edge(id_follower,agent_to_follow);
                return true;
            }
    ...
    bool followback(int prev_actor_id, int prev_target_id) {
	    ...
	    add_edge(prev_target_id,prev_actor_id);
            return true;
        }
    ...
    void remove_chatty_agent(Agent& unfollowed, Agent& lost_follower,int id_lost_follower) {
    ...
    bool handle_unfollow(int id_unfollowed, int id_lost_follower) {
        ...
        remove_chatty_agent(unfollowed, lost_follower,id_lost_follower);
